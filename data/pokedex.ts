export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	glaceonmega: {
		...
		types: ["Ice"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 65, atk: 80, def: 140, spa: 170, spd: 95, spe: 75 },
		abilities: { 0: "Slsuh Rush" },
		heightm: 0.8,
		weightkg: 25.9,
		color: "Blue",
		eggGroups: ["Field"],
	...
	gliscormega: {
		...
		forme: "Mega",
		types: ["Ground", "Flying"],
		baseStats: { hp: 75, atk: 135, def: 145, spa: 55, spd: 95, spe: 105 },
		abilities: { 0: "Toxic Eater" },
		heightm: 2.1,
		weightkg: 44.5,
		color: "Purple",
		eggGroups: ["Bug"],
	...
	neurosama: { //by Shadrake
		...
		types: ["Electric"],
		gender: "F",
		baseStats: { hp: 66, atk: 75, def: 65, spa: 115, spd: 85, spe: 99 },
		abilities: { 0: "Download", 1: "Competitive", H: "Soul-Heart" },
		heightm: 1.43,
		weightkg: 0.01,
	},
	evilneuro: {  // by Shadrake
		num: 10001,
		name: "Evil Neuro",
		types: ["Electric", "Dark"],
		gender: "F",
		baseStats: { hp: 66, atk: 115, def: 55, spa: 90, spd: 80, spe: 99 },
		abilities: { 0: "Download", 1: "Defiant", H: "Full Metal Body" },
		heightm: 1.43,
		weightkg: 0.01,
	},
	filian: {  // by Shadrake
		...
		types: ["Fighting"],
		gender: "F",
		baseStats: { hp: 104, atk: 105, def: 50, spa: 50, spd: 50, spe: 131 },
	...
	camila: {  // by Shadrake
		...
		types: ["Dark", "Flying"],
		gender: "F",
		baseStats: { hp: 75, atk: 60, def: 60, spa: 88, spd: 70, spe: 89 },
		abilities: { 0: "Prankster", 1: "Pickpocket", H: "Simple" },
		heightm: 1.53,
		weightkg: 65.05,
	},
	ellieminibot: {  // by Shadrake
		num: 10004,
		name: "Ellie Minibot",
		types: ["Steel", "Bug"],
		gender: "F",
		baseStats: { hp: 75, atk: 61, def: 98, spa: 83, spd: 128, spe: 70 },
		abilities: { 0: "Steel Worker", 1: " ", H: "Technician" },
		heightm: 1.50,
		weightkg: 70.05,
	},
	cerber: {  // by Shadrake
	...
	airys: {  // by Shadrake
		...
		types: ["Electric", "Ghost"],
		gender: "F",
		baseStats: { hp: 70, atk: 75, def: 90, spa: 105, spd: 90, spe: 80 },
	...
	ceresfauna: {  // by Shadrake
		num: 10011,
		name: "Ceres Fauna",
		types: ["Grass"],
		gender: "F",
		baseStats: { hp: 155, atk: 73, def: 85, spa: 79, spd: 75, spe: 68 },
		abilities: { 0: "Mother Nature", 1: "Natural Cure", H: "Grassy Surge" }, //Mother Nature doubles defense in sun (of all grass types?)
		heightm: 1.45,
		weightkg: 42.00,
	},
	hakosbaelz: {  // by Shadrake
		num: 10012,
		name: "Hakos Baelz",
		types: ["Psychic"],
		gender: "F",
		baseStats: { hp: 70, atk: 105, def: 75, spa: 105, spd: 75, spe: 105 },
	...
	laynalazar: {
		...
		abilities: { 0: "Innards Out", 1: "Intimidate", H: "Shed Skin" }, //Cursed Body, Dark Aura, Gooey, Guts, Aftermath, Bad Dreams, Liquid ooze, Perish Body, pressure, Regenerator, Shadow Tag, Shed Skin, Sheer Force, Stench, Unnerve,
		heightm: 1.70,
		weightkg: 75.05,
	},
   ...
   kosekibijou: {
	...
	bao: {
        ...
        abilities: { 0: "Rain Dish", 1: "Unaware", H: "Simple" },
        heightm: 1.53,
        weightkg: 43.27,
    },
	zentreya: {
        ...
        types: ["Steel", "Dragon"],
        gender: "F",
        baseStats: { hp: 75, atk: 115, def: 110, spa: 105, spd: 80, spe: 65 },
	...
	vedal: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: { hp: 60, atk: 7, def: 160, spa: 88, spd: 100, spe: 10 },
		abilities: { 0: "Shell Armor", 1: "Immunity", H: "Tera Shell" }, //technician?
		heightm: 0.30,
		weightkg: 5.1,
	},
	neuropede: {
		...
		types: ["Bug"],
		gender: "F",
		baseStats: { hp: 80, atk: 130, def: 110, spa: 56, spd: 59, spe: 77 },
		abilities: { 0: "Battle Armor", 1: "Compound Eyes", H: "Anger Point" },
		heightm: 3.30,
		weightkg: 200.1,
	},
	kokonuts: {
...
// not vtubers
	...
	//		baseStats: { hp: 56, atk: 42, def: 56, spa: 84, spd: 63, spe: 77 },
		...
		shoppingcart: {
         ...
         abilities: { 0: "Run Away", 1: "Rattled", H: " " },
         heightm: 0.8,
         weightkg: 20.00,
    },
};
